...
var VSCODE_DOTFILES_SETTINGS = path.Join(DOTFILES_PATH, "configs/vscode/settings.json")
var VSCODE_DOTFILES_EXTENSIONS = path.Join(DOTFILES_PATH, "configs/vscode/extensions.txt")
